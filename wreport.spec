...
Source0: https://github.com/arpa-simc/%{name}/archive/v%{version}-%{release}.tar.gz#/%{name}-%{version}.tar.gz
...
%changelog
* Mon Sep 25 2017 Emanuele Di Giacomo <emanuele@digiacomo.cc> 3.12-1
- Changed Source0 (emanuele@digiacomo.cc)
